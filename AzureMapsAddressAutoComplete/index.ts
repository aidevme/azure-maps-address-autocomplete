...
export class AzureMapsAddressAutoComplete implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    */
    public init(
        ...
        this.currentValue = getStringValue(context.parameters.azureMapsAddressSearchAutoComplete);
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        const props: IAzureMapsAddressAutoCompleteAppProps = {
            ...
            value: getStringValue(context.parameters.azureMapsAddressSearchAutoComplete),           
    ...
    private handleSelect(address: string, result?: AzureMapsSearchResult): void {
        ...
        if (result) {
            ...
            this.county = result.address.municipalitySubdivision ?? result.address.neighbourhood ?? '';
